...
const getStarField = () => {
  ...
  return `
        ...
        <rect x="0" y="0" width="100%" height="100%" fill="url(#${id}-gradient-1)"/>
        <defs>
        ...
        <rect x="0" y="0" width="100%" height="100%" fill="url(#${id}-gradient-2)" opacity="0.75"/>
    
        <filter id="${id}-bg">
          <feTurbulence type="fractalNoise" baseFrequency="0.01" seed="${generateRandomFloat(0, 100)}"/> 
            <feGaussianBlur stdDeviation="10"/>       
        </filter>
        <rect x="0" y="0" width="100%" height="100%" filter="url(#${id}-bg)" opacity="0.3"/>
        ...
        <rect x="0" y="0" width="100%" height="100%" filter="url(#${id}-stars)"/>
      `;
};
